...
/// A choice within a ``GuidedRecQuestion``. Pass an array of these to get results from ``Preferabli/getGuidedRecResults(selected_choice_ids:price_min:price_max:collection_id:include_merchant_links:onCompletion:onFailure:)``.
